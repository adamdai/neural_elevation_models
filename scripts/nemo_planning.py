...
from nemo.util.plotting import plot_path_3d, plot_surface
...
if AIRSIM:
    ...
    if SCENE_NAME == "AirSimMountains":
        airsim_start = np.array([[177.0, -247.0, -33.0]])
        airsim_end = airsim_start + np.array([[-192.0, -328.0, -68.0]])
        params["spiral_center"] = np.array([99.0, -449.0, -57.0])
...
if __name__ == "__main__":
    ...
    fig = plot_path_3d(
        x=astar_path[:, 0].detach().cpu().numpy(),
